...
public class NamedClass_TestCase {
    ...
    public void should_evaluateAsEffectiveBooleanValue() {
        assertThat(namedClass.evaluateAsEffectiveBooleanValue(mock(SolutionMapping.class)), is(EvaluationResult.getError()));
    }
    ...
    public void shouldReturn_Error_When_evaluateAsNumeric() {
        assertThat(namedClass.evaluateAsNumeric(mock(SolutionMapping.class)), is(EvaluationResult.getError()));
    }

    @Test
    public void shouldReturn_Error_When_evaluateAsDateTime() {
        assertThat(namedClass.evaluateAsDateTime(mock(SolutionMapping.class)), is(EvaluationResult.getError()));
    }
    ...
    public void should_evaluateAsIRI() {
        assertThat(namedClass.evaluateAsIRI(mock(SolutionMapping.class)), is(EvaluationResult.getResult(new AtomicIRI(namedClass.getIRI()))));
    }
}
