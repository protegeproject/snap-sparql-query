...
public class MD5_Evaluator_TestCase {
    ...
    public void shouldEvaluateMd5OfSimpleLiteral() {
        EvaluationResult result = evaluator.evaluate(Literal.createSimpleLiteral("abc"), SolutionMapping.emptyMapping());
    ...
    public void shouldEvaluateMd5OfStringLiteral() {
        EvaluationResult result = evaluator.evaluate(Literal.createString("abc"), SolutionMapping.emptyMapping());
        assertThat(result.isError(), is(false));
        assertThat(result.asSimpleLiteral(), is("900150983cd24fb0d6963f7d28e17f72"));
    }
}
