...
public class ISLITERAL_Evaluator_TestCase {
    ...
    public void shouldEvaluateIRIAsFalse() {
        EvaluationResult result = evaluator.evaluate(Collections.singletonList(new AtomicIRI(IRI.create("http://stuff.com"))), SolutionMapping.emptyMapping());
    ...
    public void shouldEvaluateMultiArgsAsError() {
        EvaluationResult result = evaluator.evaluate(Arrays.asList(Literal.createString("A"), Literal.createString("B")), SolutionMapping.emptyMapping());
