...
public class ISIRI_Evaluator_TestCase {
    ...
    public void shouldEvaluateIRIAsTrue() {
        EvaluationResult result = evaluator.evaluate(Collections.singletonList(iri), SolutionMapping.emptyMapping(), mock(EvaluationContext.class));
    ...
    public void shouldEvaluateMultiArgsAsError() {
        EvaluationResult result = evaluator.evaluate(Arrays.asList(iri, iri), SolutionMapping.emptyMapping(), mock(EvaluationContext.class));
