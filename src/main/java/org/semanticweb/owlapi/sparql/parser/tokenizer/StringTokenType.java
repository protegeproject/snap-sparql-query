...
public class StringTokenType extends TokenType {
    ...
    private static StringTokenType instance = new StringTokenType();

    private StringTokenType() {
    }
    ...
    public static StringTokenType get() {
        return instance;
    }
    ...
    public String toString() {
        return Objects.toStringHelper("StringTokenType")
                .toString();
    }
}
